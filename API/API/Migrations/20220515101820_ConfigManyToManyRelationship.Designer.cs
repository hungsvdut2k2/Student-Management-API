...
namespace API.Migrations
{
    ...
    [Migration("20220515101820_ConfigManyToManyRelationship")]
    partial class ConfigManyToManyRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseClassroomUserInformation", b =>
                {
                    b.HasOne("API.Models.DatabaseModels.CourseClassroom", null)
                        .WithMany()
                        .HasForeignKey("CourseClassroomsCourseClassroomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Models.DatabaseModels.UserInformation", null)
                        .WithMany()
