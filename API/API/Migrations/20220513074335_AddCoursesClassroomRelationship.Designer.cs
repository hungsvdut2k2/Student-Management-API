...
namespace API.Migrations
{
    ...
    [Migration("20220513074335_AddCoursesClassroomRelationship")]
    partial class AddCoursesClassroomRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.CourseClassroom", b =>
                {
            ...
            modelBuilder.Entity("CourseClassroomUserInformation", b =>
                {
                    b.Property<int>("CourseClassroomsCourseClassroomId")
                        .HasColumnType("int");

                    b.Property<string>("UserInformationUserId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("CourseClassroomsCourseClassroomId", "UserInformationUserId");

                    b.HasIndex("UserInformationUserId");

                    b.ToTable("CourseClassroomUserInformation");
                });
            ...
            modelBuilder.Entity("CourseEducationalProgram", b =>
                {
                    ...
                    b.HasKey("CoursesId", "EducationalProgramId");
            ...
            modelBuilder.Entity("CourseClassroomUserInformation", b =>
                {
                    b.HasOne("API.Models.CourseClassroom", null)
                        .WithMany()
                        .HasForeignKey("CourseClassroomsCourseClassroomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
